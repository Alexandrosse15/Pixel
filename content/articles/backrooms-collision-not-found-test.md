...
![Backrooms: Collision Not Found, les couloirs jaunes rendus en Unreal Engine 5 avec une netteté clinique](/images/backroomscnf/screenshot-1.webp)
...
## La réponse tient en un mot, et c'est un problème
...
![Backrooms: Collision Not Found, une entité surgit dans un environnement photoréaliste qui peine à faire peur](/images/backroomscnf/screenshot-2.webp)

## Des mécaniques qu'on connaît déjà par coeur
...
## L'accès anticipé, la prudence obligatoire
...
![Backrooms: Collision Not Found, un niveau liminal supplémentaire au rendu soigné mais sans idée neuve](/images/backroomscnf/screenshot-3.webp)
...
- Un rendu Unreal Engine 5 photoréaliste impressionnant pour un développeur solo
- Des performances tenues sur des configurations raisonnables
- La peur partagée du coop à quatre, valeur sûre du genre

**Points faibles :**

- L'hyper-réalisme trahit le flou lo-fi qui faisait toute la terreur des Backrooms
- Aucune mécanique signature, la boucle est celle de tous ses concurrents
- Un contenu d'accès anticipé encore très maigre
- Un jeu qui vend un moteur plutôt qu'une idée, dans un genre déjà saturé
