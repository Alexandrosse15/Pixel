---
title: "Dead Weight has a jaw-dropping steampunk art direction, and behind that veneer hides a genuinely clever tactics game"
seoTitle: "Dead Weight: review"
slug: "dead-weight-test"
category: "tests"
excerpt: "A flying pirate ship, floating islands to plunder and ancient gods to challenge. Dead Weight wins you over first with its style, then holds you with its turn-based tactics and class creation."
date: "2026-07-16"
author: "Alexandrosse"
readTime: "7 min"
score: 7
...
![Dead Weight, the flying pirate ship slicing through the clouds of a steampunk world](/images/deadweight/screenshot-1.webp)
...
## The art direction, that love at first sight
...
![Dead Weight, the floating islands to explore and plunder in a warm light](/images/deadweight/screenshot-2.webp)

## The mechanics: tactics and build freedom
...
![Dead Weight, a turn-based tactical battle with its class-creation freedom](/images/deadweight/screenshot-3.webp)
...
- A sumptuous, coherent steampunk art direction
- A world of floating islands and flying ships full of personality
- A class creation that offers real build freedom
- An exploration and plunder loop that feeds the tactics well

**Weaknesses:**

- An honest tactical depth but no genre revolution
- An adventure more appealing than ambitious
- Content that relies heavily on the charm of its style
