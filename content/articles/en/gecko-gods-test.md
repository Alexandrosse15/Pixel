...
- wall and ceiling movement mechanic genuinely exploited to its full potential
- level design conceived in three dimensions, rewarding attention and curiosity
- restrained and coherent art direction that serves atmosphere over spectacle
- credible and charming gecko animations
- guideless exploration that puts the player in control

**Weaknesses:**

- short runtime, five to eight hours depending on the player
- visual readability sometimes insufficient for climbable surfaces
- narrative too understated for story-driven players
- no replayability once finished
