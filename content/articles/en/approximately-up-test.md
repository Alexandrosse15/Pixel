...
The name says it all: approximately up. That is the level of ambition, and above all the level of reliability you can expect from the contraption you are about to assemble with your friends. Approximately Up is a space sandbox where you build ships out of anything that bolts together long enough to fly, and then go and see what happens.

Spoiler: what happens is rarely the flight you planned.

![Approximately Up, the modular ship assembled piece by piece](/images/approximatelyup/screenshot-1.webp)

## Bolt first, think later

It all starts with a single piece of frame and can end as a massive structure built from thousands of components. You mount oversized thrusters, annoying cables, and everything in between. The studio, Approximately Games, stresses the engineering side: you can create automated systems, wire controllers, sensors and meters to whatever you like, and let the magic happen. Or the chaos, which statistically amounts to the same thing.
...
Around that, fifteen planets to explore, each with its own feel and a dynamic soundtrack that shifts in real time as you make discoveries. Some are covered in oceans, others hide their surface under a thick atmosphere.
