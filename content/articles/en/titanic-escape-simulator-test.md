...
This is not a race against the water. It is an **investigation**.

14 April 1912. You are a private investigator aboard. What begins as a routine crossing turns darker: a suspicious death, clues, locked rooms, restricted decks, and a case buried somewhere in the ship. You question passengers, you search, you follow a trail that descends from First Class into the corridors below.

Then the iceberg arrives, and the investigation becomes something else. Corridors tilt, lights fail, water rises. What you have uncovered and **who you choose to save** become the same question.

The structure is good, and it solves the problem the community raised at announcement: four days of crossing and two hours of sinking do not make a game. Putting an investigation in the quiet part and detonating it at the moment of impact is the obvious answer, and nobody had proposed it.

The puzzles are good. Not tortuous, not gratuitous, built on the geography of the ship: you want a key, you work out where it might be, you go. That is the right measure for a game whose first wish is that you look around.

![Titanic Escape Simulator, the First Class saloons](/images/titanicescape/screenshot-2.webp)

## And it is beautiful, which was not a given
...
In 2025 a PlayStation Store listing appears for something called Titanic Escape Simulator. It goes viral. Then people look closely, and **every image is AI-generated**. So is the trailer. Dexerto, gamepressure and AllKeyShop run headlines saying the game is fake. It is noted that the name listed as publisher had put out around twenty titles that year, most with generated cover art and bought assets. On the forums the verdict lands: it is vapour, it will never ship, and if it does it will look nothing like this.

One comment summed up the mood: I will stick to Titanic: Honor and Glory and just admire the beauty of the ship.
...
**And length is the question mark.** An investigation, a sinking, branching paths: the question is how long it holds and whether you make the crossing again to see the other endings.

![Titanic Escape Simulator, the decks and the lifeboats](/images/titanicescape/screenshot-4.webp)
