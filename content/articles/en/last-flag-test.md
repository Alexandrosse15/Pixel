...
## An effective retro art direction
...
- clear concept, mastered and held through to the end without compromise
- constant tension that extends well beyond the combat moments
- real strategic depth for organised teams
- excellent visual readability, directly in service of gameplay
- energetic soundtrack that perfectly accompanies the action

**Weaknesses:**

- very limited content, a single mode with no variation
- total dependence on team play, practically unplayable for non-communicating solo players
- niche game that structurally excludes a large portion of the audience
- console version potentially problematic for gameplay precision
