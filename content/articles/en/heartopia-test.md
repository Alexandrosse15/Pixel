...
- genuinely relaxing atmosphere, with no daily login pressure
- solid social experience for playing with friends
- seamless cross-play between PC, iOS and Android
- visible improvement since the beta on performance and content
- endearing pets well integrated into the gameplay

**Weaknesses:**

- shallow gameplay that wears thin quickly in solo
- gacha present and calibrated to generate spending, at odds with the "stress-free" messaging
- PC interface that still feels like a mobile port in places
- no progression layer that deepens meaningfully over time
