...
- vertical progression through strata, varied and well-paced in the early hours
- the module system, which adds new functions rather than just inflating stats
- survival mode, which reveals the tactical potential of the game's engine
- restrained and coherent aesthetic that evolves with depth

**Weaknesses:**

- pacing that fades past the midpoint of the progression
- management interface poorly readable, visual hierarchy needs work
- sound design insufficient for long sessions
- main campaign too cautious given what survival mode demonstrates
