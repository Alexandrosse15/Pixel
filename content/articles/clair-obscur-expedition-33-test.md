...
readTime: "10 min"
score: 7.5
image_color: "from-rose-950 via-purple-950 to-slate-950"
...
## 👁️ Le problème des regards : un détail qui n'en est pas un
...
## ⚔️ Un système de combat engageant... puis mécanique
...
- univers original, vrai point de différenciation
- système de combat dynamique et engageant sur les premières heures
- vraie identité, vrai courage éditorial

**Points faibles :**

- regards et expressions faciales peu convaincants, un problème réel dans un RPG narratif
- répétitivité qui s'installe dans les combats sur la durée
- narration prometteuse mais inégale dans son exécution
- finition globale perfectible pour les standards du genre
