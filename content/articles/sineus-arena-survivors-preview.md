...
seoTitle: "Sineus Arena Survivors : preview bullet heaven co-op"
...
La mécanique de construction en temps réel pendant les vagues est l'idée qui mérite l'attention. Si elle tient ses promesses, elle force les joueurs à prendre des décisions sous pression plutôt que de se contenter d'optimiser leur build entre les rounds. C'est exactement ce qui peut faire la différence entre un bullet heaven parmi d'autres et un jeu dont on parle encore six mois après la sortie.
...
Le playtest est ouvert sur Steam. C'est la façon la plus directe de répondre à la question. Et derrière, il y a quelqu'un qui a mis beaucoup plus que du temps de développement dans ce projet. Ça ne garantit pas la qualité, mais ça dit quelque chose sur l'intention.

Sortie prévue en juin 2026 sur PC.
