...
category: "guides"
excerpt: "Le guide complet du jeu de cache-cache peinture : maîtriser l'outil de peinture, briser sa silhouette, les meilleures cachettes, les tactiques de chercheur, les trois modes et les réglages."
date: "2026-07-25"
author: "Alexandrosse"
readTime: "11 min"
...
- **La pipette** est la commande la plus importante du jeu. Pointez-la sur la surface exacte contre laquelle vous allez vous cacher, jamais sur un mur similaire à l'autre bout de la pièce : l'éclairage modifie la couleur bien plus qu'on ne le croit, et une légère différence saute aux yeux à quelques mètres.
- **Les curseurs TSL (teinte, saturation, valeur)** servent à ajuster la nuance échantillonnée vers les zones d'ombre ou de lumière de votre emplacement précis. Le curseur Valeur, à lui seul, fait toute la différence dans un coin sombre.
- **Les curseurs Métallique et Rugosité**, que la plupart des débutants ignorent, contrôlent la façon dont votre corps capte la lumière. Une couleur parfaite mais un rendu trop brillant contre un mur mat, et vous trahissez instantanément votre position. Faites correspondre le fini de la surface, pas seulement sa couleur.
- **Les échantillons de palette** enregistrent vos couleurs pour les réutiliser lors des manches suivantes sur la même carte. C'est ainsi que les habitués se recachent en quelques secondes.
- **La rotation caméra** (clic milieu) fait pivoter la vue autour de votre corps pendant la peinture, pour vérifier chaque angle sous lequel un chercheur pourrait vous voir. Des coudes blancs ou un dos non peint sont les fuites les plus courantes après une préparation bâclée.

![L'outil de peinture de Meccha Chameleon : pipette, curseurs TSL, métallique et rugosité](/images/meccha/screenshot-2.webp)

## L'erreur numéro un : les chercheurs traquent des formes, pas des couleurs
...
## La bonne routine : emplacement, peinture, pose, immobilité
...
![Le verrouillage de pose brise la silhouette et transforme le corps en objet du décor](/images/meccha/screenshot-3.webp)

## Où se cacher : imiter des objets, pas des murs
...
- **Les sols à damier ou à motifs**, dont la répétition visuelle fatigue l'oeil qui scrute.
- **Les amas de caisses ou d'objets empilés**, dont les formes qui se chevauchent brisent naturellement votre contour.
- **Les coins sombres et renfoncements de porte**, en baissant le curseur Valeur pour épouser l'ombre ambiante.
- **Les fresques et la signalétique chargées**, dont les motifs rendent la lecture de la silhouette presque impossible.
...
## Les erreurs qui trahissent les débutants
...
## Les réglages à ajuster avant de jouer
...
![Se cacher dans les motifs et les amas d'objets brouille la lecture du chercheur](/images/meccha/screenshot-4.webp)

## Nombre de joueurs, lobbies et plateformes
