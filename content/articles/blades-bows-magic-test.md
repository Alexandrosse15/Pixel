...
seoTitle: "Blades, Bows and Magic : test roguelite deck builder"
...
## La direction artistique est pixel perfect
...
- direction artistique pixel art rigoureuse et cohérente
- trois archétypes vraiment différents, builds qui divergent vraiment
- équilibrage soigné, rythme bien trouvé
- rejouabilité solide pour une production indépendante
- ce soin général qui fait la différence

**Points faibles :**

- pas de coop (on comprend, mais on regrette)
- contenu qui peut sembler limité sur la durée
- peu de surprises pour les vétérans du genre
