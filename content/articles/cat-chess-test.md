---
title: "Cat Chess ne réinvente pas les échecs, il les rend adorables, et on a ri comme jamais devant un échiquier"
...
## Le gameplay : les échecs, tout simplement
...
![Cat Chess, chaque race de chat avec sa personnalité pour chaque type de pièce](/images/catchess/screenshot-2.webp)

## Là où le jeu brille : les chats et les animations
...
![Cat Chess, une prise de pièce féline aussi drôle que satisfaisante](/images/catchess/screenshot-3.webp)
...
- Des chats aux animations expressives, drôles et pleins de personnalité
- Les échecs préservés dans toute leur profondeur, rien n'est dénaturé
- Des prises de pièces aussi hilarantes qu'adorables
- Un charme et un soin du détail qui font tout le prix du jeu

**Points faibles :**

- Ce sont les échecs, ni plus ni moins, aucune nouveauté mécanique
- Qui n'aime pas les échecs ne sera pas converti par les chats
- Un plaisir simple qui ne cache pas de profondeur insoupçonnée
