...
const translations = {
  fr: {
    ...
    game: {
      eyebrow: 'Jeu',
      sheet_title: 'Fiche technique',
      release: 'Sortie',
      developer: 'Studio',
      publisher: 'Éditeur',
      price: 'Prix',
      price_note: 'prix de base, hors promotion',
      platforms: 'Plateformes',
      genres: 'Genres',
      modes: 'Modes de jeu',
      extras: 'Compatibilité',
      steam_reviews: 'Accueil Steam',
      reviews_one: 'avis',
      reviews_many: 'avis',
      metacritic: 'Metacritic',
      early_access: 'Accès anticipé',
      coming_soon: 'Pas encore sorti',
      on_steam: 'Voir sur Steam',
      verdict: 'Notre avis',
      read_more: "Lire l'article",
      coverage: 'Notre couverture',
      similar: 'Dans le même genre',
      updated: 'Fiche relevée le',
    },
    legal: {
  ...
  en: {
    ...
    game: {
      eyebrow: 'Game',
      sheet_title: 'The facts',
      release: 'Release',
      developer: 'Developer',
      publisher: 'Publisher',
      price: 'Price',
      price_note: 'base price, excluding sales',
      platforms: 'Platforms',
      genres: 'Genres',
      modes: 'Modes',
      extras: 'Compatibility',
      steam_reviews: 'Steam reception',
      reviews_one: 'review',
      reviews_many: 'reviews',
      metacritic: 'Metacritic',
      early_access: 'Early access',
      coming_soon: 'Not out yet',
      on_steam: 'View on Steam',
      verdict: 'Our verdict',
      read_more: 'Read the article',
      coverage: 'Our coverage',
      similar: 'More like this',
      updated: 'Facts checked on',
    },
    legal: {
      title: 'Legal notice',
    },
