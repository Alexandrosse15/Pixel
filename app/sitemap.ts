...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const staticRoutes: MetadataRoute.Sitemap = [
    ...
    { url: `${SITE_URL}/creation-equipe/the-defense`, lastModified: new Date(), changeFrequency: 'monthly', priority: 0.7, alternates: { languages: { fr: `${SITE_URL}/creation-equipe/the-defense`, en: `${SITE_URL}/en/creation-equipe/the-defense` } } },
    ...
    { url: `${SITE_URL}/en/creation-equipe/the-defense`, lastModified: new Date(), changeFrequency: 'monthly', priority: 0.6, alternates: { languages: { fr: `${SITE_URL}/creation-equipe/the-defense`, en: `${SITE_URL}/en/creation-equipe/the-defense` } } },
