    ...
    <div className="mx-auto max-w-7xl px-4 py-12 md:px-8">
      <div className="mb-12 border-b border-line pb-8">
        <div className="flex items-center gap-4">
          ...
          <div>
            <p className="font-display text-xs uppercase tracking-widest text-brand">Rubrique</p>
            <h1 className="font-display text-4xl font-black uppercase text-white md:text-5xl">Tests</h1>
          </div>
        </div>
