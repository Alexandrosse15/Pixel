...
export default function TestsPage() {
  const articles = getArticlesByCategory('tests')
    ...
    <div className="mx-auto max-w-7xl px-4 py-12 md:px-8">
      ...
      <div className="mb-12 border-b border-line pb-8">
        <div className="flex items-center gap-4">
          ...
          <div>
            <p className="font-display text-xs uppercase tracking-widest text-brand">
              Rubrique
            </p>
      ...
      {articles.length === 0 ? (
        <p className="text-center text-ink-muted py-24">Aucun test pour le moment.</p>
      ) : (
